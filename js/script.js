...
// Colección de todas las imágenes
const images = Array.from(document.querySelectorAll(".myImages"));
...
function changeImage(direction) {
  ...
  // Si el índice sale de los límites, vuelve al inicio o al final
  if (currentIndex < 0) {
    currentIndex = images.length - 1; // Última imagen
